...
public class PlayerShader extends ShaderProgram{
    ...
    private static final String VERTEX_FILE = "src/main/java/shaders/playerVertexShader.vert";
    private static final String FRAGMENT_FILE = "src/main/java/shaders/playerFragmentShader.frag";
